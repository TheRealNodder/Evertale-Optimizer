window.OPTIMIZER_DOCTRINE = {
  "OPTIMIZER_DOCTRINE": {
    "dataAuthority": {
      ...
      "missingLeaderFallback": {
        "name": "No Leader Skill",
        "description": "This unit does not provide a leader skill."
      }
    },
    "teamFormats": {
      "story": {
    ...
    "monoVsRainbow": {
      ...
      "rainbowThreshold": {
        "storyDistinctElementsMin": 4
      },
      "whenToPreferMono": [
        "leaderElementMatchesMajority",
        "teamHasStrongSingleStatusPlan"
      ],
      "whenToPreferRainbow": [
        "noStrongElementLeader",
        "needCoverageOrSafety"
      ]
    },
    "optimizerSearch": {
      ...
      "varietyPressure": {
        "enabled": true,
        "penalizeOverusedTags": true,
        "penaltyPerRepeatTag": 0.15
      }
    },
    "scoringModel": {
      "baseStats": {
        ...
        "spdWeight": 0.28,
        "hpWeight": 0.2,
        "efficiencyAtkPerCostWeight": 0.1
      },
      "teamAdditives": {
        "coverageWeight": 0.25,
        "pairSynergyWeight": 0.35,
        "elementStrategyWeight": 0.4
      },
      "leaderMultiplierWeight": 0.6
    },
    "examples": {
      "explainInOneParagraph": "Build story 8 and 20 platoons from owned using leader+tag synergy and mono/rainbow.",
      "sanityChecks": [
