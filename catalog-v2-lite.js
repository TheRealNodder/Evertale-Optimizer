...
(function(){
  ...
  function normalize(entries){
    ...
    return [...chars.sort((a,b)=>Number(b.order||0)-Number(a.order||0)),...weapons.sort((a,b)=>Number(a.order||999999)-Number(b.order||999999)),...accessories.sort((a,b)=>Number(a.order||999999)-Number(b.order||999999)),...bosses.sort((a,b)=>Number(a.order||999999)-Number(b.order||999999))].filter(x=>x.id&&x.name);
  }
