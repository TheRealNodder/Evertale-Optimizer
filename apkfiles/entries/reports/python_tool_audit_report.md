...
- ACTIVE_ENTRYPOINT: 9
- LEGACY_CANDIDATE: 1
- REFERENCED_MANUAL_OR_SUPPORT: 3
...
- `tools/new_structure/renumber_entry_files.py` → `tools/legacy/tools/new_structure/renumber_entry_files.py` — Likely superseded by organize_by_handle.py and renumber_category_from_order_list.py, but must be inspected before deletion.
...
| LEGACY_CANDIDATE | `tools/new_structure/renumber_entry_files.py` | 1 | Likely superseded by organize_by_handle.py and renumber_category_from_order_list.py, but must be inspected before deletion. |
